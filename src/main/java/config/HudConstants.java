...
public class HudConstants {
    ...
    public static final int HUD_TILE_WIDTH = 100; // Width of HUD elements
    public static final int TILE_GAP = 5; // Gap in-between HUD elements
    public static final int TEAM_START_POINT = 600; // Start of the littleBeastTiles
    public static final int HUD_START_POINT = 20; // Start of battle HUD
